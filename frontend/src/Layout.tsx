  ...
  return (
    <div className="w-screen h-screen flex flex-col md:flex-row bg-neutral-950 text-neutral-100">
      <aside className="hidden md:flex w-52 lg:w-56 min-w-52 bg-neutral-950 flex-col border-r border-neutral-800/60">
            ...
            {navItems.map((item) => {
              ...
              return (
                <li key={item.path}>
                  <Link
                    to={item.path}
                    className={`flex items-center gap-2.5 px-2.5 lg:px-3 py-2 rounded-lg text-[13px] font-medium ${
                      isActive
                  ...
                  >
                    <span
                      className={`shrink-0 ${isActive ? "text-green-400" : "text-neutral-600"}`}
                    >
                      {item.icon}
                    </span>
        ...
        <div className="px-4 lg:px-5 py-3 lg:py-4 border-t border-neutral-800/60">
          <p className="text-[11px] text-neutral-600">v0.1.1</p>
        </div>
      </aside>
